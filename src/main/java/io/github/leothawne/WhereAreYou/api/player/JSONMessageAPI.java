...
public class JSONMessageAPI {
    ...
    /**
     * Creates a new {@link JSONMessageAPI} object
     *
     * @param text The text to start with
     */
    private JSONMessageAPI(String text) {
     ...
     *
     * @param text The text to start with
     * @return A new {@link JSONMessageAPI} object
     */
    public static JSONMessageAPI create(String text) {
        return new JSONMessageAPI(text);
    }
     ...
     * @return A new {@link JSONMessageAPI} object
     */
    public static JSONMessageAPI create() {
        return create("");
    }
    ...
    /**
     * Converts this {@link JSONMessageAPI} instance to actual JSON
     *
     * @return The JSON representation of this {@link JSONMessageAPI}
     */
    ...
    /**
     * Converts this {@link JSONMessageAPI} object to a String representation of the JSON.
    ...
    /**
     * Converts this {@link JSONMessageAPI} object to the legacy formatting system, which
     * uses formatting codes (like &amp;6, &amp;l, &amp;4, etc.)
     *
     * @return This {@link JSONMessageAPI} instance {@link JSONMessageAPI} in legacy format
     */
    ...
    /**
     * Sends this {@link JSONMessageAPI} to all the players specified
     *
     ...
     * @return This {@link JSONMessageAPI} instance
     */
    public JSONMessageAPI color(ChatColor color) {
        last().setColor(color);
        return this;
    }
     ...
     * @return This {@link JSONMessageAPI} instance
     */
    public JSONMessageAPI style(ChatColor style) {
        last().addStyle(style);
        return this;
    }
     ...
     * @return This {@link JSONMessageAPI} instance
     */
    public JSONMessageAPI runCommand(String command) {
     ...
     * @return This {@link JSONMessageAPI} instance
     */
    public JSONMessageAPI suggestCommand(String command) {
     ...
     * @return This {@link JSONMessageAPI} instance
     */
    public JSONMessageAPI openURL(String url) {
     ...
     * @return This {@link JSONMessageAPI} instance
     */
    public JSONMessageAPI changePage(int page) {
     ...
     * @return This {@link JSONMessageAPI} instance
     */
    public JSONMessageAPI tooltip(String text) {
     ...
     * @return This {@link JSONMessageAPI} instance
     */
    public JSONMessageAPI tooltip(JSONMessageAPI message) {
     ...
     * @return This {@link JSONMessageAPI} instance
     */
    public JSONMessageAPI achievement(String id) {
        last().setOnHover(HoverEvent.showAchievement(id));
        return this;
    }

    /**
     * Adds another part to this {@link JSONMessageAPI}
     *
     * @param text The text to start the next {@link MessagePart} with
     * @return This {@link JSONMessageAPI} instance
     */
    public JSONMessageAPI then(String text) {
     ...
     * @return This {@link JSONMessageAPI} instance
     */
    public JSONMessageAPI then(MessagePart nextPart) {
        parts.add(nextPart);
        return this;
    }
     ...
     * @return This {@link JSONMessageAPI} instance
     */
    public JSONMessageAPI bar(int length) {
    ...
    public static class HoverEvent {
         ...
         * Shows text when you hover over it
         *
         * @param message The {@link JSONMessageAPI} to show
         * @return The {@link MessageEvent}
         */
        public static MessageEvent showText(JSONMessageAPI message) {
